...
var format_NngSO2_2 = new ol.format.GeoJSON();
var features_NngSO2_2 = format_NngSO2_2.readFeatures(json_NngSO2_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32648'});
var jsonSource_NngSO2_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_NngSO2_2.addFeatures(features_NngSO2_2);
var lyr_NngSO2_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_NngSO2_2, 
                style: style_NngSO2_2,
                popuplayertitle: 'Nồng Độ SO2',
                interactive: true,
                title: '<img src="styles/legend/NngSO2_2.png" /> Nồng Độ SO2'
            });

lyr_GoogleRoad_0.setVisible(true);lyr_ranhgioihuyencat_1.setVisible(true);lyr_NngSO2_2.setVisible(true);
var layersList = [lyr_GoogleRoad_0,lyr_ranhgioihuyencat_1,lyr_NngSO2_2];
...
lyr_NngSO2_2.set('fieldImages', {'STT': '', 'Vị trí': '', 'Ký hiệu': '', 'Longitude': '', 'Latitude': '', 'Đơn vị': '', 'Tháng 1': '', 'Tháng 2': '', 'Tháng 3': '', 'Tháng 4': '', 'Tháng 5': '', 'Tháng 6': '', 'Tháng 7': '', 'Tháng 8': '', 'Tháng 9': '', 'Tháng 10': '', 'Tháng 11': '', 'Tháng 12': '', });
...
lyr_NngSO2_2.set('fieldLabels', {'STT': 'inline label - visible with data', 'Vị trí': 'inline label - visible with data', 'Ký hiệu': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Đơn vị': 'inline label - visible with data', 'Tháng 1': 'inline label - visible with data', 'Tháng 2': 'inline label - visible with data', 'Tháng 3': 'inline label - visible with data', 'Tháng 4': 'inline label - visible with data', 'Tháng 5': 'inline label - visible with data', 'Tháng 6': 'inline label - visible with data', 'Tháng 7': 'inline label - visible with data', 'Tháng 8': 'inline label - visible with data', 'Tháng 9': 'inline label - visible with data', 'Tháng 10': 'inline label - visible with data', 'Tháng 11': 'inline label - visible with data', 'Tháng 12': 'inline label - visible with data', });
lyr_NngSO2_2.on('precompose', function(evt) {
